...
The command supports `openai`, `openai-responses`, `anthropic`, `google`, `bedrock`, `cerebras`, `cohere`, `crusoe`, `groq`, `huggingface`, `mistral`, `ollama`, `openrouter`, `snowflake`, and `zai` provider prefixes.
