...
The command supports `openai`, `openai-responses`, `openai-codex`, `anthropic`, `google`, `bedrock`, `bedrock-mantle`, `cerebras`, `cohere`, `crusoe`, `groq`, `huggingface`, `mistral`, `ollama`, `openrouter`, `snowflake`, `xai`, and `zai` provider prefixes.
