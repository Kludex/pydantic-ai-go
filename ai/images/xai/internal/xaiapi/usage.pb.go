...
const (
	...
	ServiceTier_SERVICE_TIER_DEFAULT     ServiceTier = 1
	ServiceTier_SERVICE_TIER_PRIORITY    ServiceTier = 2
)
...
var (
	ServiceTier_name = map[int32]string{
		...
		1: "SERVICE_TIER_DEFAULT",
		2: "SERVICE_TIER_PRIORITY",
	}
...
func (ServerSideTool) Descriptor() protoreflect.EnumDescriptor {
	return file_xai_api_v1_usage_proto_enumTypes[1].Descriptor()
}

func (ServerSideTool) Type() protoreflect.EnumType {
	return &file_xai_api_v1_usage_proto_enumTypes[1]
}
...
const file_xai_api_v1_usage_proto_rawDesc = "" +
	...
	"\x12prompt_text_tokens\x18\x04 \x01(\x05R\x10promptTextTokens\x12.\n" +
	"\x13prompt_image_tokens\x18\x05 \x01(\x05R\x11promptImageTokens\x12)\n" +
	"\x10reasoning_tokens\x18\x06 \x01(\x05R\x0freasoningTokens\x129\n" +
	...
	"\x12%\n" +
	"!SERVER_SIDE_TOOL_IMAGE_GENERATION\x10\vB@Z>github.com/Kludex/pydantic-ai-go/ai/images/xai/internal/xaiapib\x06proto3"
...
var file_xai_api_v1_usage_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_xai_api_v1_usage_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_xai_api_v1_usage_proto_goTypes = []any{
	(ServiceTier)(0),       // 0: xai_api.ServiceTier
	(ServerSideTool)(0),    // 1: xai_api.ServerSideTool
	(*SamplingUsage)(nil),  // 2: xai_api.SamplingUsage
	(*EmbeddingUsage)(nil), // 3: xai_api.EmbeddingUsage
}
var file_xai_api_v1_usage_proto_depIdxs = []int32{
	1, // 0: xai_api.SamplingUsage.server_side_tools_used:type_name -> xai_api.ServerSideTool
