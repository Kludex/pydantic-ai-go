...
// ProviderConfig configures Mistral API access. Headers are copied.
type ProviderConfig struct {
	// Name is persisted in responses, usage, and telemetry.
	Name string
	// BaseURL is the Mistral-compatible API endpoint.
	BaseURL string
...
// IsModelAPIError allows provider fallback after active-context API failures.
